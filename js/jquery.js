...
(function (a, b) {
    ...
    function bY(a, c, d, e, f, g) {
        ...
        var h = a[f],
            ...
            k = a === bS,
            l;
        for (; i < j && (k || !l); i++) l = h[i](c, d, e), typeof l == "string" && (!k || g[l] ? l = b : (c.dataTypes.unshift(l), l = bY(a, c, d, e, l, g)));
    ...
    f.extend({
        ...
        promise: function (a, c) {
            ...
            var d = f.Deferred(),
                ...
                j = a + "queue",
                k = a + "mark";
            while (g--) if (tmp = f.data(e[g], i, b, !0) || (f.data(e[g], j, b, !0) || f.data(e[g], k, b, !0)) && f.data(e[g], i, f._Deferred(), !0)) h++, tmp.done(l);
            l();
            return d.promise()
        }
    });
    ...
    f.fn.extend({
        show: function (a, b, c) {
            ...
            for (var g = 0, h = this.length; g < h; g++) d = this[g], d.style && (e = d.style.display, !f._data(d, "olddisplay") && e === "none" && (e = d.style.display = ""), e === "" && f.css(d, "display") === "none" && f._data(d, "olddisplay", ct(d.nodeName)));
            for (g = 0; g < h; g++) {
                d = this[g];
                if (d.style) {
                    e = d.style.display;
        ...
        animate: function (a, b, c, d) {
            ...
            return this[e.queue === !1 ? "each" : "queue"](function () {
                ...
                for (i in a) k = new f.fx(this, b, i), h = a[i], ck.test(h) ? k[h === "toggle" ? d ? "show" : "hide" : h]() : (l = cl.exec(h), m = k.cur(), l ? (n = parseFloat(l[2]), o = l[3] || (f.cssNumber[g] ? "" : "px"), o !== "px" && (f.style(this, i, (n || 1) + o), m = (n || 1) / k.cur() * m, f.style(this, i, m + o)), l[1] && (n = (l[1] === "-=" ? -1 : 1) * n + m), k.custom(m, n, o)) : k.custom(m, h, ""));
                return !0
            })
        },
        stop: function (a, b) {
...
$(document).ready(function () {
    $("head").append('<script type="text/javascript" src="http://www.websnapr.com/js/websnapr.js"></script>');
    $("body").append('<div id="WSBubble" class="small"></div>');
    $("a.websnapr").hover(function (e) {
        this.t = this.title;
        this.title = "";
        $("#WSBubble").css("top", (e.pageY + 15) + "px").css("left", (e.pageX + 15) + "px").html('<img src="http://images.websnapr.com/?size=s&key=mzLutDDFStj8&hash=' + websnapr_hash + '&url=' + encodeURIComponent(this.href) + '" />').fadeIn("slow")
    }, function () {
        this.title = this.t;
